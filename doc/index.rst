...
Installation of *occ_airconics* requires a recent version of *PythonOCC*, and is compatible with the latest version, 0.17, available from the *conda* package - see `Installation <http://occ-airconics.readthedocs.io/en/latest/installation.html>`_ for more information. 
